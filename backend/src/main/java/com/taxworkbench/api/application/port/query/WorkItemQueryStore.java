...
public interface WorkItemQueryStore {
    List<WorkItemGridRow> search(String clientName, String status, String assignee, int offset, int limit);

    long count(String clientName, String status, String assignee);
}
